...
{
    char *url;
    SDL_Rect camera_pos; /*!< Rectangle*/
    SDL_Rect pos_ecran; /*!< Rectangle*/
    SDL_Surface *affichebackground; /*!< Surface. */
...
void afficherBackplayer2(background b, SDL_Surface * screen);
